...
The settings api for cashrewards.com.au
...
* [.NET Core 3.1](https://www.microsoft.com/net/download/) installed. Please review the [Currently Supported Patch](https://github.com/aws/aws-lambda-dotnet#version-status) for your project type.
...
var projects = new []
{
    sourceDir.Path + "SettingsAPI/SettingsAPI.csproj",
...
...
    SettingsAPIFunction:
        ...
        Properties:
            CodeUri: ./artifacts/SettingsAPI.zip
            ...
```
...
aws cloudformation describe-stacks \
    --stack-name settingsapi --query 'Stacks[].Outputs'
```